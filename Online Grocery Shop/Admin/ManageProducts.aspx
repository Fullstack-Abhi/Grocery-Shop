            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtprice" ValidationExpression="^[0-9]*Rs" runat="server" ForeColor="#990000" ErrorMessage="Enter Only Number" Display="Dynamic"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td>Description</td>
                ...
                <Columns>
                  ...
                  <asp:TemplateField HeaderText="Unit">
                    ...
                    <asp:TemplateField HeaderText="Price">
                        <ItemTemplate>
                            Rs<asp:Label ID="lblPrice" runat="server" Text='<%# Bind("Price") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
